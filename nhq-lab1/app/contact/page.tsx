...
export default function ContactPage() {
  ...
  // Cho phép người dùng quay lại form sau khi gửi thành công
  const [showForm, setShowForm] = useState(true);

  const submitted = state.success && !showForm;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <a
              href="mailto:nguyenhuuquang@sv.dlu.edu.vn"
              className="text-blue-600 hover:underline text-sm"
            >
              nguyenhuuquang@sv.dlu.edu.vn
            </a>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
            <h3 className="font-semibold mb-1">GitHub</h3>
            <a
              href="https://github.com/nhquang2509"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-600 hover:underline text-sm"
            >
              github.com/nhquang2509
            </a>
          </div>
          <div className="bg-gray-50 rounded-lg p-4">
